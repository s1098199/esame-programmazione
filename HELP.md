...
* The original package name 'com.uni.mario-stefano.demo.esame' is invalid and this project uses 'com.uni.mariostefano.demo.esame' instead.
...
```
$ docker run --rm -p 8080:8080 demo.esame:0.0.1-SNAPSHOT
```
