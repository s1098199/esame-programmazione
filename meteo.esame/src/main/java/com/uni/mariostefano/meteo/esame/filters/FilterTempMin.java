package com.uni.mariostefano.meteo.esame.filters;
	...
	public class FilterTempMin implements FilterStats {
		 ...
		 * Restituisce un JSONArray contenente JSONObject che rappresentano le città e le relative temperature minime. 
		...
		/**
		 * Questo metodo calcola la media della temperatura minima su sette giorni delle città passate in ingresso e
		 * filtra rispetto al value.
		 * Restituisce un JSONArray contenente JSONObject che rappresentano le città e le relative temperature minime. 
