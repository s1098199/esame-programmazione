package com.uni.mariostefano.meteo.esame.filters;
	...
	public class FilterFeelsLike implements FilterStats {
		 ...
		 * Restituisce inoltre un JSONArray contenente JSONObject che rappresentano le città e le relative 
		...
		/**
		 * Questo metodo calcola la media della temperatura percepita su sette giorni delle città passate in ingresso e
		 * filtra rispetto al value.
		 * Restituisce un JSONArray contenente JSONObject che rappresentano le città e le relative 
		 * temperature percepite. 
		 * A seconda di value c'è un JSONObject che rappresenta la città con max/min valore di temperatura percepita
		 * 
		 * @param cities rappresenta le città con cui si vuole fare la statistica e il filtraggio
